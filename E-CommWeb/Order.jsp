...
<html>
<head>
<title>Address and Contact Information</title>
...
<body>
	...
	<div class="sign_up">
		<form class="sign" action="OrderAddressDetails" method="post">
			<div class="formtitle">Please enter the valid Information</div>
			<div class="section">
			...
			<div class="section">
				...
				<div class="input-sign details1">
					<input type="text" placeholder="Address2" name="address2" required />
				</div>
				<div class="clear"></div>
			</div>
			<div class="section-country">
				<select id="country" onchange="change_country(this.value)"
					class="frm-field required" name="change_country(this.value)">
			...
			<div class="submit">
				<input class="bluebutton submitbotton" type="submit" value="Confirm" />
			</div>
		</form>
	</div>
</body>
